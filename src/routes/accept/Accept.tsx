...
const Accept = () => {
  ...
  return (
    <div className='flex flex-col w-full h-auto items-center justify-around gap-20 pt-11'>
      <h3 className='text-4xl px-2 text-center xl:text-6xl'>
        Ya tienes un asesor inmobiliario!
      </h3>
      <div className='flex flex-col  bg-white w-full xl:w-3/5 shadow-md py-20 px-24 justify-center items-center gap-10'>
